...
import com.hm.seleniumFactory.PropertyLoader;
...
public class DataUtil {
	...
	public Object[][] sendData(Method method) throws IOException {
		...
		return ExcelUtils.readExcel(
				System.getProperty("user.dir") + PropertyLoader.getProperties("ExcelfilePath").trim(),
				PropertyLoader.getProperties("fileName").trim(),
				method.getAnnotation(FrameworkAnnotation.class).dataSheetName());
